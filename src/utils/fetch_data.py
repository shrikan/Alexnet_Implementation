...
def read_cifar_10(image_width, image_height):
    ...
    batch_1 = __unpickle('../data/cifar-10-batches-py/data_batch_1')
    batch_2 = __unpickle('../data/cifar-10-batches-py/data_batch_2')
    batch_3 = __unpickle('../data/cifar-10-batches-py/data_batch_3')
    batch_4 = __unpickle('../data/cifar-10-batches-py/data_batch_4')
    batch_5 = __unpickle('../data/cifar-10-batches-py/data_batch_5')
    test_batch = __unpickle('../data/cifar-10-batches-py/test_batch')
